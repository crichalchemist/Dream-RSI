...
- Out-of-support replay: none of the 3 versions replayed on clipped episodes (12 episodes each).
  ...
  replay's history, which stops before the replayed trace.
- Untouched programs:
